...
const TestimonialCard = ({ quote, name, role, facility, delay = "" }: TestimonialCardProps) => {
  return (
    <div className={`relative h-full bg-[#0a1527]/95 backdrop-blur-sm rounded-xl p-6 shadow-lg transition-all duration-300 hover:shadow-xl border border-white/10 hover:border-blue-500/20 animate-fade-up ${delay}`}>
