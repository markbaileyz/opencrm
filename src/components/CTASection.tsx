          ...
          <div className="relative z-10 p-8 md:p-14 text-white">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="lg:pr-10">
                ...
                <p className="text-lg mb-8 text-white/90 animate-fade-up delay-100">
                ...
                <div className="flex flex-col sm:flex-row gap-4 animate-fade-up delay-200">
                  <Link to="/login">
                    <ButtonCustom size="lg" className="group bg-white text-primary hover:bg-white/90 shadow-md">
                      Get Started
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20 hover:bg-white/20 transition-colors shadow-lg">
                  <div className="p-3 inline-flex rounded-full bg-white/20 mb-4">
                    <Shield className="h-6 w-6" />
                  </div>
                  <h3 className="text-xl font-semibold mb-2">HIPAA Compliant</h3>
                  <p className="text-white/90">Secure platform that meets all healthcare regulatory requirements</p>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20 hover:bg-white/20 transition-colors shadow-lg">
                  ...
                  <p className="text-white/90">Reduce administrative work by up to 40% with automation</p>
                </div>
                
                <div className="bg-white/10 backdrop-blur-sm p-6 rounded-xl border border-white/20 hover:bg-white/20 transition-colors shadow-lg sm:col-span-2">
                  <div className="p-3 inline-flex rounded-full bg-white/20 mb-4">
                    <Users className="h-6 w-6" />
                  </div>
                  <h3 className="text-xl font-semibold mb-2">Improve Patient Experience</h3>
                  <p className="text-white/90">Deliver exceptional care with streamlined communication and scheduling</p>
                </div>
              </div>
            </div>
          </div>
